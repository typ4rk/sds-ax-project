...
> 78건 중 47건을 확인했다. 반면 **에이전트(LLM) 경로는 전부 미실행**이며, 아래 1절 질의별
...
[verification.md](../verification.md)의 케이스 78건을 기능별로 집계한다.
...
현재 통과율 **47/78 (60%)** — 출시 기준(90%) 미달. Fail은 아직 없고 전부 미실행이다.
확인된 47건의 목록은 [verification.md](../verification.md) 「현재까지 확인된 항목」 참고.
