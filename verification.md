...
- **출시 기준: 전체 테스트 케이스 중 90% 이상 Pass** ([service.md](service.md) 성공 기준 8).
  아래 케이스는 총 54건(수집 14 / 탐지 10 / 매칭 기록 6 / 저장 7 / 조회 11 / 알림 6)이므로
...
| 3 | 탐지 정확도 | 2-1, 2-2, 2-9, 2-10 |
| 4 | 내결함성 | 1-9, 4-3, 4-4 |
| 5 | 데이터 무결성 | 3-1 ~ 3-6, 5-8 |
| 6 | 즉시성 | 6-1, 6-3 |
| 7 | 재현성 | 4-7 |
| 8 | 전체 통과율 90% | 위 54건 전체 |
...
**1-1, 1-2, 1-4, 1-5, 1-6, 1-7, 1-9, 1-13, 1-14, 2-1, 2-2, 2-7, 2-9, 2-10, 3-1, 3-3, 4-3, 5-1, 5-2, 5-3, 6-1, 6-2, 6-4** (23 / 54)
